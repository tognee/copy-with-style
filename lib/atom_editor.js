...
export default class Editor {
  ...
  force_scroll(){
    ...
    if (this.el.getMaxScrollTop() == 0) this.new_scroll_position()
  }
  ...
  get_line( div ){
    ...
    let row = parseInt( div.dataset['screenRow']);
    let buffrow = this.editor.bufferPositionForScreenPosition([row,0]);
